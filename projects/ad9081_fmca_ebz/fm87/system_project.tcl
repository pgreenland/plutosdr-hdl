...
set_location_assignment PIN_P51   -to "fpga_refclk_in(n)"   ; ## D05  GBTCLK0_M2C_N
set_location_assignment PIN_R50   -to "fpga_refclk_in"      ; ## D04  GBTCLK0_M2C_P

set_location_assignment PIN_AT65   -to "rx_data[3](n)"       ; ## A11  DP3_M2C_N
set_location_assignment PIN_AU66   -to "rx_data[3]"          ; ## A10  DP3_M2C_P
set_location_assignment PIN_BH65   -to "rx_data[2](n)"       ; ## A07  DP2_M2C_N
set_location_assignment PIN_BJ66   -to "rx_data[2]"          ; ## A06  DP2_M2C_P
set_location_assignment PIN_AR68   -to "rx_data[1](n)"       ; ## A03  DP1_M2C_N
set_location_assignment PIN_AP69   -to "rx_data[1]"          ; ## A02  DP1_M2C_P
set_location_assignment PIN_BG68   -to "rx_data[0](n)"       ; ## C07  DP0_M2C_N
set_location_assignment PIN_BF69   -to "rx_data[0]"          ; ## C06  DP0_M2C_P
set_location_assignment PIN_BD65   -to "rx_data[7](n)"       ; ## B13  DP7_M2C_N
set_location_assignment PIN_BE66   -to "rx_data[7]"          ; ## B12  DP7_M2C_P
set_location_assignment PIN_BB69   -to "rx_data[6](n)"       ; ## B17  DP6_M2C_N
set_location_assignment PIN_BC68   -to "rx_data[6]"          ; ## B16  DP6_M2C_P
set_location_assignment PIN_AY65   -to "rx_data[5](n)"       ; ## A19  DP5_M2C_N
set_location_assignment PIN_BA66   -to "rx_data[5]"          ; ## A18  DP5_M2C_P
set_location_assignment PIN_AW68   -to "rx_data[4](n)"       ; ## A15  DP4_M2C_N
set_location_assignment PIN_AV69   -to "rx_data[4]"          ; ## A14  DP4_M2C_P

set_location_assignment PIN_AR62   -to "tx_data[3](n)"       ; ## A31  DP3_C2M_N
set_location_assignment PIN_AP63   -to "tx_data[3]"          ; ## A30  DP3_C2M_P
set_location_assignment PIN_BG62   -to "tx_data[2](n)"       ; ## A27  DP2_C2M_N
set_location_assignment PIN_BF63   -to "tx_data[2]"          ; ## A26  DP2_C2M_P
set_location_assignment PIN_AY59   -to "tx_data[1](n)"       ; ## A23  DP1_C2M_N
set_location_assignment PIN_BA60   -to "tx_data[1]"          ; ## A22  DP1_C2M_P
set_location_assignment PIN_BH59   -to "tx_data[0](n)"       ; ## C03  DP0_C2M_N
set_location_assignment PIN_BJ60   -to "tx_data[0]"          ; ## C02  DP0_C2M_P
set_location_assignment PIN_BD59   -to "tx_data[7](n)"       ; ## B33  DP7_C2M_N
set_location_assignment PIN_BE60   -to "tx_data[7]"          ; ## B32  DP7_C2M_P
set_location_assignment PIN_BC62   -to "tx_data[6](n)"       ; ## B37  DP6_C2M_N
set_location_assignment PIN_BB63   -to "tx_data[6]"          ; ## B36  DP6_C2M_P
set_location_assignment PIN_AW62   -to "tx_data[5](n)"       ; ## A39  DP5_C2M_N
set_location_assignment PIN_AV63   -to "tx_data[5]"          ; ## A38  DP5_C2M_P
set_location_assignment PIN_AT59   -to "tx_data[4](n)"       ; ## A35  DP4_C2M_N
set_location_assignment PIN_AU60   -to "tx_data[4]"          ; ## A34  DP4_C2M_P
...
#set_location_assignment PIN_AA45   -to "gpio[0]"             ; ## H19  LA15_P
#set_location_assignment PIN_AD46   -to "gpio[1]"             ; ## H20  LA15_N
#set_location_assignment PIN_BF48   -to "gpio[2]"             ; ## H22  LA19_P
#set_location_assignment PIN_BC47   -to "gpio[3]"             ; ## H23  LA19_N
#set_location_assignment PIN_AA49   -to "gpio[4]"             ; ## D17  LA13_P
#set_location_assignment PIN_AD50   -to "gpio[5]"             ; ## D18  LA13_N
#set_location_assignment PIN_U49    -to "gpio[6]"             ; ## C18  LA14_P
#set_location_assignment PIN_W50    -to "gpio[7]"             ; ## C19  LA14_N
#set_location_assignment PIN_BC51   -to "gpio[8]"             ; ## G18  LA16_P
#set_location_assignment PIN_BF52   -to "gpio[9]"             ; ## G19  LA16_N
#set_location_assignment PIN_AT46   -to "gpio[10]"            ; ## G25  LA22_N
set_location_assignment PIN_T47   -to "hmc_gpio1"           ; ## H17  LA11_N
set_location_assignment PIN_Y47   -to "hmc_sync"            ; ## H14  LA07_N
#set_location_assignment PIN_AK51   -to "irqb[0]"             ; ## G12  LA08_P
